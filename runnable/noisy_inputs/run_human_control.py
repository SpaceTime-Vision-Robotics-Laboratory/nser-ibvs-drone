...
class HumanController(BaseStreamingController):
...
if __name__ == "__main__":
    ...
    controller = HumanController(
        ip=args.ip,
        processor_class=HumanProcessor,
        speed=args.speed
    )

    if args.simulated:
        controller.initialize_position(forward_distance=0.0, right_distance=0.0, down_distance=0.5)
