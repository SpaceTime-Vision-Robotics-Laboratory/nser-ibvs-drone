...
from auto_follow.processors.yolo_ibvs_processor import YoloIbvsProcessor
...
if __name__ == "__main__":
    ...
    controller = BasicController(
        ip=args.ip,
        processor_class=YoloIbvsProcessor,
        speed=args.speed,
        log_path="./logs",
    ...
    if args.simulated:
        controller.initialize_position(takeoff_height=10, gimbal_angle=-90, back_distance=0, left_distance=1.0)
