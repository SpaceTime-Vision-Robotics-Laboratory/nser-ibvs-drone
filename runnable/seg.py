...
def retrieve_keypoints(model_path: Path, frame_path: Path):
    ...
    if results.boxes and results.boxes.conf is not None and len(results.boxes.conf) > 0:
        ...
        ## TODO need to manually reorder if not in the expected order (with front first)
        bbox_oriented_points = bbox_oriented_points[1:] + [bbox_oriented_points[0]]
...
if __name__ == "__main__":
    ...
    model_path = Path("/home/mihaib08/Desktop/_research_2025/drone_lab/auto-follow/models/real-yolo-car-full-segmentation.pt")
    frame_path = Path("/home/mihaib08/Desktop/_research_2025/drone_lab/auto-follow/assets/reference/images/____frame_001160_9928240_real_45_recording.jpg")
