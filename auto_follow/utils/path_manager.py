...
class Paths:
    ...
    GOAL_FRAME_PATH_90: Final[Path] = (
        BASE_DIR / "assets" / "reference" / "images" /
        "frame_001009_10636251.png"
    )
    GOAL_FRAME_POINTS_PATH_90: Final[Path] = (
        BASE_DIR / "assets" / "reference" / "data" /
        "frame_001009_10636251.json"
    )

    GOAL_FRAME_PATH_45: Final[Path] = (
        BASE_DIR / "assets" / "reference" / "images" /
        "frame_002041_12392083__45.png"
    )
    GOAL_FRAME_POINTS_PATH_45: Final[Path] = (
        BASE_DIR / "assets" / "reference" / "data" /
        "frame_002041_12392083__45.json"
    )
