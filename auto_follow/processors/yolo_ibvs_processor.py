...
class YoloIbvsProcessor(BaseVideoProcessor):
    def __init__(
            self,
        ...
        if target_data.is_lost or target_data.center is None:
            ...
            if is_inside_box and target_data.ellipse_keypoints is not None:
                ...
                for i in range(7):
                    ...
                    L_eff[2*i, 2] = (current_features[2*i] - frame_center_x) / frame_width
                    L_eff[2*i+1, 2] = (current_features[2*i+1] - frame_center_y) / frame_height
                ...
                ibvs_rot_cmd = int(np.clip(150*command_vec[3], -100, 100))  # Rotation
