...
class ImageBasedVisualServo:
    ...
    def compute_normalized_image_plane_coordinates(self, points: list[tuple[int, int]]) -> list[tuple[float, float]]:
        points_normalized = []
        for p in points:
    ...
    def compute_velocities(self, plot: bool = False, verbose: bool = False):
