...
from auto_follow.processors.distiled_network_processor import DistiledNetworkProcessor
...
class IBVSController(BaseStreamingController):
    def __init__(self, ip: DroneIp, processor_class=DistiledNetworkProcessor, **kwargs):
...
if __name__ == '__main__':
    ...
    controller = IBVSController(
        ip=ip,
        processor_class=DistiledNetworkProcessor,
    )
